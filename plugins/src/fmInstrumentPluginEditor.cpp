...
void FmInstrumentPluginEditor::imguiFrame()
{
  ...
  ImGui::BeginChild("Sub1", ImVec2(ImGui::GetWindowContentRegionWidth() * 0.48f, 300), true);
  // Plot waveform
  ...
  ImGui::BeginChild("Sub2", ImVec2(ImGui::GetWindowContentRegionWidth() * 0.5f, 480), false);
  ...
  ImGui::BeginChild("Sub3", ImVec2(0, 480), false);
