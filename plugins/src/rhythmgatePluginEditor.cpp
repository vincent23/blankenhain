...
void RhythmgatePluginEditor::imguiFrame()
{
	...
	if (ImGui::DragFloat("slider0", &unnormalized0, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider1", &unnormalized1, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider2", &unnormalized2, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider3", &unnormalized3, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider4", &unnormalized4, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider5", &unnormalized5, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider6", &unnormalized6, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider7", &unnormalized7, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider8", &unnormalized8, 0.1f, min, max, "%.3f", 1 / skew))
	...
	if (ImGui::DragFloat("slider9", &unnormalized9, 0.1f, min, max, "%.3f", 1 / skew))
