...
class bh2_example_effect : public EffectBase
{
...
public:
	...
	bh2_example_effect() : EffectBase(NUMBER_OF_PARAMETERS, 512u), delayLine(size_t(aux::millisecToSamples(2502u)))
	{
...
class BH2_example : public PluginBase
{
public:
	BH2_example(audioMasterCallback audioMaster)
		: PluginBase(audioMaster, new bh2_example_effect())
	{ }
