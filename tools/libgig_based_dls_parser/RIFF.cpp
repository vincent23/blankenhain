...
// *
    ...
    Chunk::Chunk(File* pFile, List* pParent, uint32_t uiChunkID, unsigned int uiBodySize) {
        this->pFile      = pFile;
...
// *
     ...
     */
    Chunk* List::AddSubChunk(uint32_t uiChunkID, unsigned int uiBodySize) {
