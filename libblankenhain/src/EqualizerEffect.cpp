...
EqualizerEffect::EqualizerEffect() : EffectBase(5, 512)
{
...
void EqualizerEffect::process(Sample* buffer, size_t sampleFrames, size_t numberOfParameters, float* parameters)
{
