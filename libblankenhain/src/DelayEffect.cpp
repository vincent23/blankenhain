...
DelayEffect::DelayEffect() : EffectBase(4, 512u), delayLine(size_t(aux::millisecToSamples(2502u)))
{
...
void DelayEffect::process(Sample* buffer, size_t numberOfSamples, size_t numberOfParameters, float* parameters)
{
